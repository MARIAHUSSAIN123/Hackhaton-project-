...
@keyframes auroraShift{
  ...
  50%{
    background-position:15% 20%, 80% 25%, 45% 85%, 0 0;
  }
}
...
@keyframes glowPulse{
    0%,100%{
        box-shadow:0 0 12px rgba(244,162,97,0.18);
    }

    50%{
        box-shadow:0 0 26px rgba(244,162,97,0.4);
    }
}
...
.kpi::after{
    ...
    background:
        radial-gradient(
            160px circle at 50% 0%,
            color-mix(
                in srgb,
                var(--accent, var(--teal)) 22%,
                transparent
            ),
            transparent 70%
        );
